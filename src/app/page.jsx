          ...
          <form action="/report">
            <div className="flex flex-col ">
              ...
              <div className="flex flex-wrap gap-3">
                <input className="bg-inputfieldcolor rounded-full bordercolor  px-3 py-2 mr-3 w-2/3 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondarycolor" type="text" id="url" name="url" required />
